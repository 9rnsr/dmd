    ...
    for (size_t i = 0; i < n; i++)
    {
        ...
        L1:
            if (!(p.storageClass & STClazy && p.type.ty == Tvoid))
            {
                ...
                if (auto wm = arg.type.deduceWild(p.type, isRef))
                {
                    if (wildmatch)
...
public:
    ...
    final bool checkPurity(Scope* sc, VarDeclaration v)
    {
        ...
        else
        {
            ...
            if (auto fdp = vparent.isFuncDeclaration())
            {
        ...
        if (i != -1)
        {
            ...
            if (e)
            {
                ...
                if (e.type.castMod(0) != type.castMod(0) && type.ty == Tsarray)
                {
                    ...
                    auto length = cast(size_t)tsa.dim.toInteger();
            ...
            if (cd.isNested())
            {
                ...
                else if (fdn)
                {
                    ...
                    for (Dsymbol sp = sc.parent; 1; sp = sp.parent)
                    {
                        ...
                        else if (auto fld = sp.isFuncLiteralDeclaration())
                        {
                            fld.tok = TOKdelegate;
                        }
                    }
...
public:
    ...
    Expression semantic(Scope* sc)
    {
        ...
        if (auto ex = resolveUFCS(sc, this))
            return ex;
        /* This recognizes:
         *  foo!(tiargs)(funcargs)
         */
...
public:
    ...
    Lagain:
        ...
        if (t1b.ty == Ttuple)
        {
            ...
            auto j1 = cast(size_t)i1;
            auto j2 = cast(size_t)i2;
            Expression e;
            if (e1.op == TOKtuple)
            {
                auto exps = new Expressions();
...
public:
    ...
    Expression semantic(Scope* sc)
    {
        ...
        if (t1.ty != Tclass && t1.ty != Tstruct)
        {
            ...
            {
                auto ie = cast(IntervalExp)(*arguments)[0];
    ...
    final Expression semantic(Scope* sc)
    {
        ...
        if (e1.op == TOKarray)
        {
            ...
            if (ad)
            {
                ...
                {
                    auto aex = cast(ArrayExp)ae.copy();
        ...
        if (e1.op == TOKslice)
        {
            ...
            if (ad)
            {
                ...
                if (ad.aliasthis && t1 != ae.att1)
                {
                    auto aex = cast(SliceExp)ae.copy();
                    if (!aex.att1 && t1.checkAliasThisRec())
                        aex.att1 = t1;
                    aex.e1 = new DotIdExp(loc, ae.e1, ad.aliasthis.ident);
                    this.e1 = aex;
         ...
         */
        {
             ...
             *      f() = value
             */
            if (auto e = resolvePropertiesX(sc, e1x, e2))
                return e;
        ...
        Ltupleassign:
            ...
            {
                auto tup1 = cast(TupleExp)e1;
                auto tup2 = cast(TupleExp)e2x;
...
public:
    ...
    Expression semantic(Scope* sc)
    {
        ...
        {
            auto ae1 = cast(AddrExp)e1;
            auto ae2 = cast(AddrExp)e2;
            if (ae1.e1.op == TOKvar && ae2.e1.op == TOKvar)
            {
                auto ve1 = cast(VarExp)ae1.e1;
                auto ve2 = cast(VarExp)ae2.e1;
                if (ve1.var == ve2.var)
                {
