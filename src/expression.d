...
public:
    ...
    extern (D) this(Loc loc, ScopeDsymbol sds)
    {
        ...
        this.sds = sds;
        assert(!sds.isTemplateDeclaration());   // instead must use TemplateExp
    }
...
public:
    ...
    override Expression semantic(Scope* sc)
    {
        ...
        {
            hasOverloads = false;//assert(!hasOverloads);
...
public:
    ...
    override Expression semantic(Scope* sc)
    {
        ...
        {
            TemplateDeclaration td = (cast(TemplateExp)e2).td;
