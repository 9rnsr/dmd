...
#if 1// addMember will create alias explicitly, so this 'hack' will be unnecessary
    if (!aliasId)
...
void Import::semantic(Scope *sc)
{
    ...
    if (mod)
    {
        ...
        if (!aliasId)   // renamed import currently works as like static import. So this is necessary
