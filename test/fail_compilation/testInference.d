...
fail_compilation/testInference.d(96): Error: cannot implicitly convert expression (c) of type testInference.C1 to immutable(C1)
...
fail_compilation/testInference.d(98): Error: cannot implicitly convert expression (c) of type testInference.C3 to immutable(C3)
fail_compilation/testInference.d(101): Error: undefined identifier X1
fail_compilation/testInference.d(101):        did you mean public function 'testInference.x1'?
fail_compilation/testInference.d(107): Error: cannot implicitly convert expression (s) of type S1 to immutable(S1)
fail_compilation/testInference.d(110): Error: cannot implicitly convert expression (a) of type int*[] to immutable(int*[])
fail_compilation/testInference.d(111): Error: cannot implicitly convert expression (a) of type const(int)*[] to immutable(int*[])
...
fail_compilation/testInference.d(117): Error: cannot implicitly convert expression (s) of type S2 to immutable(S2)
fail_compilation/testInference.d(119): Error: cannot implicitly convert expression (a) of type const(int)*[] to immutable(int*[])
---
*/
...
TEST_OUTPUT:
---
fail_compilation/testInference.d(135): Error: cannot implicitly convert expression (f10063(cast(inout(void*))p)) of type inout(void)* to immutable(void)*
---
*/
