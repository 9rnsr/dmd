...
void test10306()
{
    double[3] a = [2,-2,2], b = [4,4,4], c = a;

    double[3] r1 = (a[] - b[]) * c[];   assert(r1 == [-4,12,-4]);
    double[3] aux = a[] - b[];          assert(aux == [-2,-6,-2]);
    double[3] r2 = aux[] ^^ 2;          assert(r2 == [4,36,4]);
    double[3] r3 = (a[] - b[]) ^^ 2;    assert(r3 == r2);
    double[3] r4 = (a[] - b[])[] ^^ 2;  assert(r4 == r2);
}
