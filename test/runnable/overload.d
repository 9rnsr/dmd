...
struct S1680
{
    int _y;
             ...
             int blah1()      { return _y; }
    static S1680 blah1(int n) { return S1680(n); }

    static S1680 blah2(int n)    { return S1680(n); }
...
class C1680
{
    ...
    this(int n){}
             ...
             int blah1()      { return _y; }
    static C1680 blah1(int n) { return new C1680(n); }

    static C1680 blah2(int n)    { return new C1680(n); }
